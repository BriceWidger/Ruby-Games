...
if answer == "y"  #See if the player elected not to play
  ...
  ###############################################
    ...
    #Prompt the player to provide some input
    print %Q{Enter the last name of the heroes. (Press Enter)\n\n: }
    lastname = STDIN.gets  #Force the player to press Enter to continue
    lastname.chomp!  #Remove any extra characters appended to the string
  
    Console_Screen.cls  #Clear the display area
  
    #Prompt the player to provide some input
    print %Q{Enter how many days and nights the storm will rage. (Press Enter)\n\n: }
    cloudduration = STDIN.gets  #Force the player to press Enter to continue
    cloudduration.chomp!  #Remove any extra characters appended to the string
  ...
  Console_Screen.cls  #Clear the display area
    #Prompt the player to provide some input
    print %Q{The collection of player input is complete. The game is now ready to tell the 
story. (Press Enter)\n\n }
    a = STDIN.gets  #Force the player to press Enter to continue
    a.chomp!  #Remove any extra characters appended to the string
  ...
  named Alexander #{lastname}, William #{lastname} and Molly #{lastname}. 
  These children were known far and wide as the heroes who once saved the 
  inhabitants of #{location} from an evil #{monster}. One day dark clouds 
  descended over #{location}. For #{cloudduration} nights and #{cloudduration} 
  days a great storm raged, flooding all of the land in #{location}, driving 
  its inhabitants up into the hills. (Press Enter)
  ...
  Story.P5 = %Q{  This game is called the Ruby Tall Tale game. Originally 
  it was designed by Jerry Lee Ford, Jr. but later modified by 
  Brice Widger. Brice Widger currently resides in New York.
  URL: https://www.bellevue.edu/ (Press Enter)
  ...
  Console_Screen.cls  #Clear the display area
  puts "Come back to play another time!\n\n"
