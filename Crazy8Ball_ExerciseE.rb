...
class Ball
  ...
  def get_fortune
    ...
    case randomNo
      ...
      when 6
        $prediction = "unknown"
      when 7
        $prediction = "death is likely"
      when 8
        $prediction = "insert more money"
      when 9
        $prediction = "absolutely"
      when 10
        $prediction = "not looking good"
    end
  ...
  def say_greeting
    ...
    1. Accept to have your fortune predicted
    2. Type in your question and press enter to have your fortune predicted
    3. When prompted, type q to quit the game" +
    "\n\n\n\n\n\n\n\n\n\n\n\n\nPress Enter to " +
               "continue. \n\n: "
    print greeting
  end
...
if answer == "n"  #See if the player elected not to play
  ...
  puts "Thanks for playing the Virtual Crazy 8-Ball game!
