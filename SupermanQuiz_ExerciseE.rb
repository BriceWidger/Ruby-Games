...
def display_instructions
    ...
    print "Press 1 to continue or 2 to see grading scale."
    
    end

  #Display the quiz's grading scale
  def disp_scale
    puts "GRADING SCALE:\n\n"
    puts "6 or less correct, your rank = Good Citizen"
    puts "7 correct, your rank = Side Kick"
    puts "8 or more correct, your rank = Superhero\n\n\n\n\n\n\n\n\n"
  ...
  def determine_grade
    ...
    if $noRight >= 6 then
      ...
      puts "You have earned a rank of: Side Kick" if $noRight == 7
      puts "You have earned a rank of: Superhero" if $noRight >= 8
      ...
      puts "You can watch the movies here: "
...
#you can loop here if you don't want to end your code if user selects 2 loop do .......... break if answer === "1" at the end of else
...
#ANSWERS FOR THE QUIZ: a, c, b, b, d, b, c, b, d, a
...
SQ.disp_q("How many basic colors of Kryptonite are there?",
  "a. Two", "b. Three", "c. Four", "d. Five", 
  "b")

  #Call upon the disp_q method and pass it the seventh question
SQ.disp_q("What is the object Superman is holding on the cover of his comics?",
  "a. Donald Trump", "b. A stale twinkie", "c. A car", "d. A boombox", 
  "c")

  #Call upon the disp_q method and pass it the eighth question
SQ.disp_q("What color kryptonite causes weakness and is eventually fatal to natives of Krypton?",
  "a. Yellow", "b. Green", "c. Blue", "d. Superman is colorblind", 
  "b")

  #Call upon the disp_q method and pass it the nineth question
SQ.disp_q("What is Superman's birth name?",
  "a. Nerd Boy", "b. Justin Bieber", "c. RuPaul", "d. Kal-El", 
  "d")

  #Call upon the disp_q method and pass it the tenth question
SQ.disp_q("Who is Clark Kent married to?",
  "a. Lois Lane", "b. Cardi B", "c. Andy Dick", "d. Turtlez", 
  "a")
...
loop do
  ...
  #Asking if player wants to retake quiz
