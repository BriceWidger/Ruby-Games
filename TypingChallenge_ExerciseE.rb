...
class Test
  ...
  def display_instructions
    ...
    You will get a letter grade of A for nine or ten correctly typed
    sentences, a B for eight, a C for seven, a D for six, and an F for
    five or lower.
    \n\n\n\n\n\n\n\n\n
...
if answer == "n"  #See if the player elected not to play
  ...
  Typing_Test.present_test "Brice will get an A on this assignment."
  Typing_Test.present_test "Slugs are my spirit animals."
  Typing_Test.present_test "It's getting cold outside."
  Typing_Test.present_test "Foosball is the devil, Bobby."
  Typing_Test.present_test "This is the 10th sentence."
