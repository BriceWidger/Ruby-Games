...
class Game
  ...
  def display_instructions
    ...
    puts "Starting each round, the game randomly chooses a word from an" 
    puts "array of 40 words, with all words consisting of five to ten characters." 
    puts "Use your special brain to try and guess the secret word for each round!"
    puts "To do this, the game asks you to choose five consonants and one vowel."
    puts "If you guess any consonant or vowel correctly, it will be displayed on"
    puts "the screen to help you guess the secret word. Underscore characters"
    puts "are used to represent letters that have not been guessed.\n\n"
    puts "Good luck! And make mom proud!\n\n\n\n\n\n\n\n\n"
  ...
  def select_word
    ...
    words = ["W I N D O W", "S T A T I O N", "H A M B U R G E R",
             ...
             "H A P P Y", "F U N N Y", "T U R T L E", "C H E E S E",
             "P I C K L E", "G O B L I N", "W I N N E R", "S P I R I T",
             "R A N D O M", "P E E R S", "C A L I F O R N I A", "C L O W N S",
             "G I R L S", "B O I L S", "R E N T L E", "T O M A T O", "C A E S A R",
             "S C H O O L", "S U C C E S S", "P E O P L E", "S H I R T S"]
  ...
  def get_consonants
    ...
    5.times do  #Iterate 5 times
      ...
      if list.include?(input.upcase) == true then
        ...
        # Displays a list of the wrong guesses already guessed
        # Reference:
        # https://stackoverflow.com/questions/33339112/remove-double-quotes-from-a-string-rails-4
        print "\n\nLetters guessed: "
        str="\"#{list}\""
        str.gsub!('"', '')
        puts str
    ...
    3.times do |i|  #i equals 0 on the first iteration of the loop
      ...
      if reply == shortWord then  #The player's guessed the secret word
        ...
        if i == 1 then 
          ...
          print "The word was "
          # Coverting all letters of secret word to downcase,
          # then using regex for first letter of secret word to uppercase
          # Reference:
          # https://stackoverflow.com/questions/15627434/how-to-change-case-of-letters-in-string-using-regex-in-ruby
          print shortWord.downcase.sub(/\w/){$&.upcase}
          print ". Press Enter to continue."
        else
...
if answer == "n" or answer == "N"  #See if the player elected not
...
elsif answer == "h" or answer == "H" #activate hidden display instructions
  ...
  loop do  #Loop forever
    ...
    print "Enter Q to quit, h for instructions, or press any key to play again: "
    ...
    #Terminate the loop if valid input was provided
    break if answer =~ /Q|h/i 
  
  end

if answer == "h" or answer == "H" #activate hidden display instructions
